...
export default function SortDropdown({ setSort, options }) {
	...
	return (
		<div>
			<Dropdown
				label="Sort By"
				class="text-off-white border-gunmetal bg-viridian shadow-lg shadow-viridian/50 hover:bg-ash-gray font-medium rounded-lg text-sm text-center mr-2 mb-2 ease-in duration-150"
			>
